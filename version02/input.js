...
const rx2 = document.getElementById("dial00-value");
const ry2 = document.getElementById("dial01-value");
const rz2 = document.getElementById("dial02-value");
...
function getValues() {
    return {
        x: readNumber(document.getElementById("dial00-value")),
        y: readNumber(document.getElementById("dial01-value")),
        z: readNumber(document.getElementById("dial02-value")),
    };
}
...
const TARGET_ID = 'three-output-002'; // must match output page
